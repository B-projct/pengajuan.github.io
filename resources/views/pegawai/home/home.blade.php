        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-4">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <p class="text-muted">Sistem Pengajuan WINCORP</p>
                                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title mb-4">Data Pegawai Yang Mengajukan</h4>
                ...
                <div class="col-xl-8">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title mb-4">Data Pengajuan Dana</h4>
