    ...
    <div class="page-title-box">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h4 class="page-title mb-1">Edit Akun Pegawai</h4>
                            ...
                            <form action="{{ Route('data-pegawai.update', $user->id) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <input type="file" name="filefoto"
                                            class="dropify @error('filefoto') is-invalid @enderror" data-height="100"
                                            data-allowed-file-extensions="png jpg jpeg" data-default-file="/profil/{{ $user->foto }}">
                                        @endif
                                    </div>
                                </div>
                                <hr>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <select class="custom-select @error('akun') is-invalid @enderror" name="akun">
                                            ...
                                            <option value="survey" {{ $user->type == 'survey' ? 'selected' : '' }}>Tim Survey</option>
                                        </select>
                                        @error('akun')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="mt-5">
                                    <button type="submit" class="btn btn-primary w-100">Perbaharui Akun Pegawai {{ Str::title($user->nama) }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
