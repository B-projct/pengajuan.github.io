    ...
    <div class="page-title-box">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h4 class="page-title mb-1">Data Pengajuan Yang Telah Di Terima dan Di ACC</h4>
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{ route('pegawai.home') }}">Dashboard</a></li>
                        <li class="breadcrumb-item active">/</li>
                        <li class="breadcrumb-item active">Data Pengajuan Yang Telah Di Terima dan Di ACC</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            <h4 class="header-title">Data Pengajuan Yang Telah Di Terima dan Di ACC</h4>
                            <p class="card-title-desc">
                                Data Pengajuan yang di acc dan selanjutnya pembuatan jadwal pencairan dana
                            </p>
