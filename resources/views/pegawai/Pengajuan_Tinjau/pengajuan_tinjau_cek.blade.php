                    ...
                    @foreach ($pengajuan as $data)
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-title-desc">List Detail Data Pengajuan</p>
                                ...
                                <div class="tab-content p-3">
                                    <div class="tab-pane active" id="masyarakat" role="tabpanel">
                                        ...
                                        <p class="card-title-desc">Data Pengajuan Dana</p>
                                    ...
                                    <div class="tab-pane" id="usaha" role="tabpanel">
                                        ...
                                        <p class="card-title-desc">Data Usaha Yang Di Ajukan Untuk
                                            Mendapatkan Bantuan Dana</p>
                                        ...
                                        <div class="media mb-2">
                                            ...
                                            <div class="media-body">
                                                <h5 class="font-size-15">Nomor Pengajuan : P /
                                                    {{ date('m', strtotime($data->created_at)) }} /
                                                    0{{ $data->id_pengajuan }}</h5>
                                                <p>Detail Data Pengajuan Dana</p>
                                                <div class="mb-2">
