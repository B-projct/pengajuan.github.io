    ...
    <div class="page-title-box">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h4 class="page-title mb-1">Pengajuan Dana WINCORP</h4>
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{ route('pegawai.home') }}">Dashboard</a></li>
                        <li class="breadcrumb-item active">/</li>
                        <li class="breadcrumb-item active">Pengajuan Dana WINCORP</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            <h4 class="header-title">Data Yang Menunggu Persetujuan Pengajuan Dana</h4>
                            <p class="card-title-desc">
                                Data Pengajuan Dana WINCORP Melalui Sistem Pengajuan
                            </p>
