                ...
                <ul class="navbar-nav navbar-center">
                    @if (Route::has('login'))
                        ...
                        @else
                            ...
                            <li class="nav-item">
                                <a href="{{ route('register') }}" class="nav-link">Sigin</a>
                            </li>
                        @endauth
                    @endif
                </ul>
    ...
    <section class="hero-1-bg" style="background-image: url(/HTML/images/hero-1-bg-img.png)" id="home">
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-6">
                    <h1 class="hero-1-title text-dark fw-bold text-shadow mb-4">Selamat Datang Di Sistem Pengajuan WINCORP</h1>
                    <div class="w-75 mb-5 mb-lg-0">
                        <p class="text-muted mb-5 pb-5 font-size-17">Pengajuan Dana Keuangan Semakin 
                            Mudah dan Cepat | Repost by <a href='https://winproperty.co.id/' title='winproperty.co.id' target='_blank'>winproperty.co.id</a>
                            </p>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="wc-box rounded text-center wc-box-success p-4">
                                ...
                                <h5 class="fw-bold mb-2 wc-title mt-4">Form Pengajuan Dana</h5>
                                <p class="text-muted mb-0 font-size-15 wc-subtitle">Mengisi Form Pengajuan Dana</p>
                            </div>
                            <div class="wc-box rounded text-center wc-box-success p-4">
                                <div class="wc-box-icon">
                                ...
                                <p class="text-muted mb-0 font-size-15 wc-subtitle">Pengajuan Akan Di Terima Bila Data Yang 
                                    Di Masukkan Sudah Benar Dan Sesuai</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="text-center mb-5">
                        ...
                        <p class="text-muted font-size-15">Dengan Sistem ini Pengajuan Dapat Mempermudah
                            Pelaporan dan Mempercepat Approve Pengajuan</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-5 offset-lg-1">
                    ...
                    <h3 class="font-weight-semibold line-height-1_4 mb-4">Tepat <b>Akurat</b> & <b>Membantu</b>
                        Untuk Mempermudah <b> Bagi Para Pegawai WINPROPERTY</b></h3>
                    <p class="text-muted font-size-15 mb-4">Sistem Pengajuan Yang Terintegritas Dengan Sistem Keuangan 
                        Di Perusahaan Dan Terkoneksi Satu Dengan Yang Lain.
                    </p>
                </div>
            </div>
        </div>
