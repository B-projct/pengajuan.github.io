                ...
                <div class="col-xl-5 col-sm-8">
                    <div class="card">
                        <div class="card-body p-4">
                            <div class="p-2">
                                <h5 class="mb-5 text-center">Login untuk Masuk Sistem Informasi Pengajuan</h5>
                                <br><center><p>Repost by <a href='https://winproperti.co.id/' title='winproperti.co.id' target='_blank'>winproperti.co.id</a></p></center>
