            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <div class="timeline" dir="ltr">
                        <form action="{{ route('pengajuan-LPDB.update', $data->id_pengajuan) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                                                    ...
                                                    <div class="col-md-12 mt-3">
                                                        <div>
                                                            ...
                                                            @enderror"
                                                                name="bentuk_usaha">
                                                                <option value="UMKM"
                                                                    {{  $data->bentuk_usaha == 'UMKM' ? 'selected' : '' }}>
                                                                    Usaha Mikro Kecil Menengah (UMKM)
                                                                </option>
                                                                <option value="CV"
                                                                    {{ $data->bentuk_usaha == 'CV' ? 'selected' : '' }}>
                                                                    Commanditaire Vennootschap (CV)
                                                                </option>
                                                                <option value="PT"
                                                                    {{ $data->bentuk_usaha == 'PT' ? 'selected' : '' }}>
                                                    ...
                                                    <div class="col-md-12 mt-3">
                                                        <div>
                                                            ...
                                                            <input type="file" name="filenpwp"
                                                                ...
                                                                data-height="100"
                                                                accept="image/jpeg, image/png, image/jpg" data-default-file="/koperasi/npwp/{{ $data->npwp }}">
                                                            @error('filenpwp')
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="col-md-12 mt-3">
                                                        <div>
                                                            ...
                                                            <input type="file" name="filepermohonan"
                                                                ...
                                                                data-height="100" accept="application/pdf" data-default-file="/koperasi/permohonan/{{ $data->permohonan }}">
                                                            @error('filepermohonan')
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="col-md-12 mt-3">
                                                        <div>
                                                            ...
                                                            <input type="file" name="fileproposal"
                                                                ...
                                                                data-height="100" accept="application/pdf" data-default-file="/koperasi/proposal/{{ $data->proposal }}">
                                                            @error('fileproposal')
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="col-md-12 mt-3">
                                                        <div>
                                                            ...
                                                            <input type="file" name="fileakta"
                                                                ...
                                                                data-height="100" accept="application/pdf" data-default-file="/koperasi/akta/{{ $data->akta }}">
                                                            @error('fileakta')
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="col-md-12 mt-3">
                                                        <div>
                                                            ...
                                                            <input type="file" name="filekeuangan"
                                                                ...
                                                                data-height="100" accept="application/pdf" data-default-file="/koperasi/keuangan/{{ $data->keuangan }}">
                                                            @error('filekeuangan')
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="col-md-12 mt-3">
                                                        <div>
                                                            ...
                                                            <input type="file" name="filelegalitas"
                                                                ...
                                                                data-height="100" accept="application/pdf" data-default-file="/koperasi/legalitas/{{ $data->legalitas }}">
                                                            @error('filelegalitas')
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                        </div>
