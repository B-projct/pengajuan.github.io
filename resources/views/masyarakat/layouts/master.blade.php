...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>WINCORP | Sistem Pengajuan</title>
            ...
            <div class="main-content">
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-6">
                                2024 © WINCORP | Repost by <a href='https://winproperty.co.id/' title='winproperty.co.id' target='_blank'>winproperty.co.id</a>

                            </div>
                            <div class="col-sm-6">
                                <div class="text-sm-right d-none d-sm-block">
                                    Crafted with <i class="mdi mdi-heart text-danger"></i> by Cahyo bagus Putro Pratomo
                                </div>
                            </div>
                        </div>
                    </div>
